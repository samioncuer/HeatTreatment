#pragma checksum "C:\SamioProjeler\KBS_Proje\Views\HeatTreatment\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9ad30c8f6def724094d4d42a95a09fb55c9727a5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9ad30c8f6def724094d4d42a95a09fb55c9727a5", @"/Views/HeatTreatment/Index.cshtml")]
    ...
    public class Views_HeatTreatment_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\SamioProjeler\KBS_Proje\Views\HeatTreatment\Index.cshtml"
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9ad30c8f6def724094d4d42a95a09fb55c9727a53362", async() => {
                WriteLiteral("\r\n\t<style>\r\n");
                WriteLiteral("\t</style>\r\n");
            }
            );
...
<!--------------------------------- chart ------------------------------>
	<div style=""display:inline-block; margin-left:100px; margin-top:20px;"">
		<div id=""exp-jpg"" style=""margin-left:60px; display: none;"">
			<a id=""download"" href=""javascript:voi");
            WriteLiteral(@"d(0)"" class=""btn btn-xs btn-primary"" onclick=""toJpeg()"">JPEG OLUŞTUR</a>
		</div>
	...
	$('#grd_grfk').datagrid({
		...
		columns:[[
			...
			{field:'action',title:'Action',width:110,align:'center',
				...
				");
                WriteLiteral(@"		var c = '<a href=""javascript:void(0)"" onclick=""cancelrow_grfk(this)"">Cancel</a>';
						return s+c;
					} else {
			...
			{field:'action',title:'Action',width:110,align:'center',
				formatter:function(value,row,index){
					if (row.editing){
						...
						var e = '<a href=""javascript:void(0)"" onclick=""editrow_okyc(th");
                WriteLiteral(@"is)"">Edit</a> ';
...
$('#grd_nkt').datagrid({
		...
		columns:[[
			...
			{field:'beklemesuresi',title:'Be");
                WriteLiteral(@"kleme Süresi',width:120,align:'center',editor:'timespinner',
				formatter: function(value,row,index){
					return value.hours + ':' + value.minutes;
				}
			},
		...
		onAfterEdit:function(index,row){
			...
			var p = row.grafikid;
			var noktaJson = $.pos");
                WriteLiteral(@"t( BaseURL + '/Nokta/GetNoktaById',{ grafikId:p }
				,function(result){
					$('#grd_nkt').datagrid('loadData',result);
...
function editrow_nkt(target){
	$('#");
                WriteLiteral(@"grd_nkt').datagrid('beginEdit', getRowIndex(target));
	}
	...
	$.messager.confirm('Confirm','Are you sure?',function(r){
		...
		$(document).ready(function () { 
			...
			var noktaJson = $.post( BaseURL + '/Nokta/GetNoktaById',{ grafikId:p }
				,function(result){
					$('#grd_nkt').datagrid('loadData',result);
					var jqxhrs = $.post( BaseURL + ""/Grafik/GetGrafikBas");
                WriteLiteral(@"lamaById"", { grafikId:p }
							,function(res) {
								var jqxhrs = $.get( BaseURL + ""/Okuyucu/GetOkuyucu"", function(okuyucu) {
								draw(result,okuyucu,res);
								$('#exp-jpg').show();
...
function insert_grfk(){
	...
	if (row){
		var index = $('#gr");
                WriteLiteral(@"d_grfk').datagrid('getRowIndex', row);
	} else {
		index = 0;
	}
...
function insert_nkt(){
	var row = $('#grd_nkt').datagri");
                WriteLiteral(@"d('getSelected');
	if (row){
	...
	//chart.destroy();
	$('#chart2').append('<canvas id=""chart1""><canv");
                WriteLiteral(@"as>');
                ...
                WriteLiteral(@" == 0)
					{
						...
						{     //burası düzenlenecek
							...
							for (; date.isBefore(calcTime); date = date.clone(");
                WriteLiteral(@").add(10, 'minutes')) {
...
");
		...
		Chart.plugins.register({
			...
			afterDraw: function(c) {
				...
				ctx.font = ""18px Arial"";
				ctx.fillStyle = ""black"";
				ctx.fillText('-KARTAL BOMBE-' + '                                                                         ");
                WriteLiteral(@"         ' +'Work Number:', c.chart.width /2, 20);
				ctx.restore();
							}
			});  
